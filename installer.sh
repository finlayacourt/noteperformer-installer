...
if [ response != 'n' ]
  then
    curl https://raw.githubusercontent.com/finlayacourt/noteperformer-installer/master/libfaketime.1.dylib > /Applications/Sibelius.app/Contents/Frameworks/libfaketime.1.dylib
